...
- [x] **[OXC-02]** Build and validate shared Oxc configuration packages `Priority: 🟠` `Complexity: L`
- [x] **[OXC-01]** Evaluate native Oxc tooling and shared package value `Priority: 🟠` `Complexity: L`
